define('#pub-app', ['jquery', '#pub-util'], function(require, exports) {
  var $    = require('jquery');
  ...
  Module.extend = function(config, _super, extend) {
    ...
    var newModule = function(_config, parent, idObject) {
      this.config = {};
      ...
      if (_super.isMaster) {
        newModule.master(this, null, this.config);
      }
    }
    exports.extend(newModule, _super, extend);
